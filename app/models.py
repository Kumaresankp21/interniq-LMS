...
class Course(models.Model):
    ...
    Certificates = models.CharField(null=True,max_length=200)
...
class UserCourse(models.Model):
    ...
    course = models.ForeignKey(Course, on_delete=models.CASCADE)
    paid = models.BooleanField(default=0,null=True)
...
class Payment(models.Model):
    ...
    user_course =  models.ForeignKey(UserCourse, on_delete=models.CASCADE,null=True) # Storing additional user data in JSON format
...
class Blog(models.Model):
    ...
    content = RichTextField()  # Use RichTextField for advanced content
    featured_image = models.ImageField(upload_to="Media/blog_images", null=True, blank=True)
